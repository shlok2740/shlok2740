            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl">
                  Open to hackathons, research collaborations, contract engineering, and technical writing. Reach out on any platform below — I respond asynchronously, usually within 24 hours.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  >
                    <a href="https://github.com/shlok2740" target="_blank" rel="noopener noreferrer">
                      Open GitHub
                  ...
                  >
                    <a href="https://medium.com/@shlokkumar2303" target="_blank" rel="noopener noreferrer">Read on Medium</a>
                  </Button>
                </div>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-2">
                  {ctaLinks.map((link) => (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-xs font-mono text-muted-foreground hover:text-foreground border border-foreground/10 hover:border-foreground/30 px-3 py-2 transition-all duration-300"
                    >
                      {link.icon}
                      <span>{link.name}</span>
                    </a>
                ...
                <p className="text-sm text-muted-foreground mt-8 font-mono">
                  Based in India · Open to remote & async collaboration
                </p>
              </div>
